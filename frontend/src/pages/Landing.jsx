          ...
          {grp.items.map((p, pi) => (
            <div key={p.name} className="flex items-center gap-2 px-3 py-2"
              style={{
                ...
                animation: `lnd-fadein .3s ease both ${gi * 120 + pi * 80 + 100}ms`,
              }}>
      ...
      <div className="min-h-screen text-white" style={{
        ...
        <section className="max-w-6xl mx-auto px-6 pt-20 pb-16 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-3 justify-center">
            ...
            <Link to="/demo"
              className="inline-flex items-center justify-center gap-2 bg-blue-500/10 hover:bg-blue-500/20 border border-blue-500/30 transition-colors px-7 py-3.5 rounded-xl font-semibold text-sm text-blue-300">
              <span className="w-1.5 h-1.5 rounded-full bg-blue-400 animate-pulse" />
              Ver demo
            </Link>
            <Link to="/login"
